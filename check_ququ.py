    ...
    def load_queue(self):
        with open(self.filename, 'rb') as f:
            ...
            for current_column_count, data in enumerate(data_list):
                ...
                self.tableWidget.setItem(0, current_column_count, QTableWidgetItem(str(real_states)))
                ...
                self.tableWidget.setItem(3, current_column_count, QTableWidgetItem(str(setpoints)))
